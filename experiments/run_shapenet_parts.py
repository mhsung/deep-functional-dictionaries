...
parser.add_argument('--decay_step', type=int, default=16881 * 20)
parser.add_argument('--decay_rate', type=float, default=0.5)
parser.add_argument('--bn_decay_step', type=int, default=16881 * 20 * 2)
...
if __name__ == '__main__':
    ...
    # Create data.
    train_data = shapenet_parts.create_dataset(
            args.exp_type, args.batch_size, 'train')
    val_data = shapenet_parts.create_dataset(
            args.exp_type, args.batch_size, 'val')
    test_data = shapenet_parts.create_dataset(
    ...
    # Run.
    run(args, train_data, val_data, test_data)
